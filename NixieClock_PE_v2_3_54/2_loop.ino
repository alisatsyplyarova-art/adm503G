...
#if HAS_SECONDS
    // v2.3.53: secFlipActive держит вызов flipTick() на всех итерациях, пока идёт угасание секундных
    // ламп в FM_SMOOTH (само по себе оно не устанавливает newSecFlag/newTimeFlag дольше
    // одного вызова - иначе цикл угасания оборвался бы на первом же шаге).
    if ((newSecFlag || newTimeFlag || secFlipActive) && curMode == 0) flipTick();     // перелистывание цифр
#else
